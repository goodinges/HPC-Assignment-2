...
*
* Explanation:
* Different implemntations uses different methods to send and recieve messages
* through network or even within one computer. Furthermore different platforms
* have different internal mechanisms to carry the messages through network or
* within memory. Many aspects of a computer affects the time it takes to carry
* a message from one process to another. Moreover OS's CPU scheduler makes
* undeterministic decisions on when to execute Processes and their message
* moving commands.
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
